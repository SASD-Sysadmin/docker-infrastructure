...
- [PHP-SDK](php-sdk.md)
- [SDK-Status und Validierung](sdk-status-and-validation.md)
...
## Plattform- und Paketmodell

- [AlmaLinux-9- und Rocky-Linux-9-Agents](redhat-family-agents.md)
- [Plattformabhängige Paketdaten](cross-platform-package-data.md)
- [SELinux-/Firewall-Grenze](selinux-and-firewall-boundary.md)
- [Anwendungsprofile](application-profiles.md)
- [Rollenkatalog](role-catalog.md)

## Lifecycle und Compliance
