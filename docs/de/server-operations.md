...
Vor Paketupdates CA und Konfiguration sichern, Versionskompatibilität prüfen, Wartungsfenster nutzen und anschließend Server, CA, Deployment und Agent-No-op testen. PuppetDB ist in Milestone 3 noch nicht enthalten.
