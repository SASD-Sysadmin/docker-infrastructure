# @summary Assign a lifecycle-aware Combined Java and PHP command-line development host.
class role::polyglot_development {
  ...
  class { 'profile::application_state':
    role_name        => 'polyglot_development',
    enabled_profiles => ['baseline', 'platform_state', 'administration_tools', 'development_tools', 'sdk_status', 'java_sdk', 'php_sdk', 'lifecycle_state'],
  }
